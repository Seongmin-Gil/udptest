...
public class Test : MonoBehaviour
{
    ...
    string strIP = "192.168.0.2"; // 서버 아이피를 적자, <127.0.0.1  은 자기자신의 컴퓨터 ip를 지칭>
 
    int port = 10004;  // 접속 할 서버의 포트를 적자
    Socket sock; // 소켓
    IPAddress ip;
    IPEndPoint endPoint;
    ...
    void ServerCheck()
    {
        while (true)
        {
            ...
            {
                Debug.Log(e.Message);
            } // try - catch 로 정해놓은 버퍼의 크기 이상의 패킷량이 왔을경우를 대비
        }
    }
